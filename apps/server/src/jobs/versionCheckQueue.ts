...
const GITHUB_API_LATEST_URL = 'https://api.github.com/repos/jimski427/Tracearr/releases/latest';
const GITHUB_API_ALL_RELEASES_URL = 'https://api.github.com/repos/jimski427/Tracearr/releases';
const GITHUB_RELEASES_URL = 'https://github.com/jimski427/Tracearr/releases';
